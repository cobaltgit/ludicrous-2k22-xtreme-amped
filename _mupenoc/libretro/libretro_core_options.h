...
struct retro_core_option_definition option_defs_us[] = {
    ...
    {
        CORE_NAME "-Xtreme Overclock Factor",
        "Overclock Factor",
        "Override cycle calculation with reduced count factor (overclock) when set greater than 0. This will lower the cycle count calculation by half per incremented value. This feature may cause instability (differs per game). Enabling overclock will set Xtreme OverClock to 1.",
        {
            {"none", NULL},
            {"1", NULL},
            {"2", NULL},
