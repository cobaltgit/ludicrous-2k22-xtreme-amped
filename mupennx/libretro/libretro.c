...
static void setup_variables(void)
{
    struct retro_variable variables[] = {
...
#endif
        { CORE_NAME "-Framerate",
            "Framerate; Fullspeed|Original" },
        { CORE_NAME "-virefresh",
            "VI Refresh (Overclock); 2200|1500|Auto" },
        ...
        { CORE_NAME "-Xtreme OverClock",
            "Xtreme OverClock; 3|2|1|0|4|5|6|7|8|9|10" },
        { NULL, NULL },
    };
...
void retro_get_system_info(struct retro_system_info *info)
{
    ...
    info->library_name = "Mupen64 Xtreme";
...
void update_variables()
{
    ...
    var.key = (AspectRatio == 1 ? CORE_NAME "-hd43screensize" : CORE_NAME "-169screensize");
    var.value = NULL;
    if (environ_cb(RETRO_ENVIRONMENT_GET_VARIABLE, &var) && var.value)
    {
    ...
    var.key = CORE_NAME "-Xtreme OverClock";
    var.value = NULL;
    if (environ_cb(RETRO_ENVIRONMENT_GET_VARIABLE, &var) && var.value)
    {
