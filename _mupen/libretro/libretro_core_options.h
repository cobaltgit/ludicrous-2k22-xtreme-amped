...
struct retro_core_option_definition option_defs_us[] = {
    {
        CORE_NAME "-Xtreme-TurboBoost",
        "Xtreme TurboBoost",
        "Xtreme TurboBoost is used to exploit performance and speed on lower spec platforms.  Does not function well with Frame Buffering enabled!  But, some games, such as Jet Force Gemini, are capable of working, case by case scenario...by having TurboBoost set to 2, in conjunction with Frame Buffering! Changing this will break stuff!",
        {
            {"0", NULL},
            {"X1", NULL},
            {"X2", NULL},
    ...
    },
    {
        ...
        "Xtreme OverClock",
        "Xtreme OverClock is used to approximate the Counter reg, 0 will use the embedded Database (or default to 2). Changing this will break stuff!",
        {
            {"0", NULL},
            {"X1", NULL},
            {"X2", NULL},
    ...
    },
    {
        CORE_NAME "-virefresh",
        "Xtreme OverClock VI",
        "Select a VI Refresh clock, Auto does not impact behaviour, other values override CountPerScanline, Anything lower than 1500 or higher than 2200 is unstable!",
        {
            {"Auto", NULL},
            {"800", NULL},
            {"900", NULL},
    ...
    },
    {
        ...
        "Xtreme Crash Fix",
        "Dynarec only! Best left OFF! Unsafe, Unstable Hacky Solution, which fixes freezes and crashes for OoT, KI, various rom hacks. Ignores emulated TLB Exceptions.",
        {
            {"False", "Don't Ignore"},
